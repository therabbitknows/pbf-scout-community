...
a separately redacted private snapshot; never connect this public repository
to private sources or treat notebook output as authority. GitBook work is
stopped unless explicitly reauthorized.
